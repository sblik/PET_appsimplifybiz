<?php
/**
 * Template Name: SMPLFY Operations
 * Version: 0.2
 * Description: PDF version of Operations
...
$model_files = [
    'Operations Variables' => $template_dir . 'model/operations.php',
];

$view_files = [
    'Styles View'     => $template_dir . 'view/styles.php',
    'Header View'     => $template_dir . 'view/header.php',
    'Operations View' => $template_dir . 'view/operations.php',
...
safe_include($model_files['Operations Variables'], 'Operations Variables', [
    'form_data' => $form_data,
]);

// Load remaining model files, passing globals
foreach ($model_files as $label => $file) {
    if ($label === 'Operations Variables') {
        continue;
    }
    safe_include($file, $label, [
        'form_data'            => $form_data,
        'variables_operations' => $variables_operations,
    ]);
}
